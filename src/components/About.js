              ...
              <div className="flex w-[19rem] md:w-[30rem] m-auto whitespace-pre">
                {tile.id % 2 === 0 || tile.id === 0 ? 
                  <div className="w-full grid grid-cols-3 gap-1">
                    <img src={tile.img} alt={`${tile.name}`} className='w-36 h-24 md:h-28 m-auto inline-block text-wrap px-4 border-r-2 dark:border-slate-300'/>
                ...
                <div className="w-full grid grid-cols-3 gap-1">
                    ...
                    <img src={tile.img} alt={`${tile.name}`} className='w-36 h-24 md:h-28 m-auto inline-block text-wrap px-4 border-l-2 dark:border-slate-300'/>
                  </div>
                }
