  ...
  return (
    <React.Fragment>
      <div className='flex'>
        ...
        <div className='flex flex-col w-full mx-auto h-screen p-10 dark:bg-gray-800 bg-stone-200 text-gray-200'>
          ...
          <form ref={form} onSubmit={sendEmail} className="flex-col w-96 mx-auto rounded-md">
            ...
            <button type="submit" value="Send" className='border cursor-pointer dark:border-gray-700 text-gray-600 transition duration-500 ease-in-out delay-550 hover:dark:border-red-200 hover:text-red-200 font-bold py-2 px-6 mr-4 rounded-lg header-title float-right'> Send </button>
          </form>
        </div>
      </div>
  </React.Fragment>
